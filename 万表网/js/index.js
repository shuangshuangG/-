var createEle = function(item,ele){
	this.ele = ele ? ele : "";
	this.item = item;
	this.init(this.item,this.ele);
}
createEle.prototype = {
...
$.ajax({
	...
	success: function(res){
				res.forEach(function(item){
					var $a =  new createEle(item).init(item);
					$("#btn_left").before($a);
				})
				bannerRun();
		}
...
$.ajax({
	...
	success:function(res){
		res.forEach(function(item){
			new createEle(item,".w_list_slide");
		})
	}
})
...
$.ajax({
	...
	success:function(res){
		res.forEach(function(item){
			new createEle(item,".w_fast_right");
		})
	}
})
...
$.ajax({
	...
	success:function(res){
		res.forEach(function(item){
			new createEle(item,".popularityShop");
		})
	}
})
